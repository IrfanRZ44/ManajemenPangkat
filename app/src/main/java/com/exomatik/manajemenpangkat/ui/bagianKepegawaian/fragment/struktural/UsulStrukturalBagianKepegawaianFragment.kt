package com.exomatik.manajemenpangkat.ui.bagianKepegawaian.fragment.struktural
...
class UsulStrukturalBagianKepegawaianFragment : Fragment() {
    private lateinit var savedData : DataSave
    private var listPengajuan = ArrayList<ModelUsulanStruktural>()
    private var adapter: AdapterUsulStrukturalBagianKepegawaian? = null
    ...
    private fun myCodeHere(){
        ...
        adapter =
            AdapterUsulStrukturalBagianKepegawaian(
                listPengajuan,
    ...
    private fun onClickItem(item: ModelUsulanStruktural) {
        val intent = Intent(activity, DetailStrukturalBagianKepegawaianActivity::class.java)
            ...
            override fun onDataChange(result: DataSnapshot) {
                ...
                if (result.exists()) {
                    for (snapshot in result.children) {
                        ...
                        if (data != null){
                            if (data.statusPengajuan == "BagianKepegawaian" && !data.statusDitolak){
