...
class UsulanBiodataActivity : AppCompatActivity() {
    private lateinit var savedData : DataSave

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        setContentView(R.layout.activity_usulan_biodata)
        myCodeHere()
    }
    ...
    private fun onClick() {
        ...
        btnNext.setOnClickListener {
            val intent = Intent(this, UsulanAdministrasi1Activity::class.java)
            startActivity(intent)
            finish()
        }
    }
