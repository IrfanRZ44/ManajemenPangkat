...
class UsulPelaksanaBagianKepegawaianFragment : Fragment() {
    private lateinit var savedData : DataSave
    private var listPengajuan = ArrayList<ModelUsulanPelaksana>()
    private var adapter: AdapterUsulPelaksanaBagianKepegawaian? = null
    ...
    private fun myCodeHere(){
        ...
        adapter = AdapterUsulPelaksanaBagianKepegawaian(
                listPengajuan,
    ...
    private fun onClickItem(item: ModelUsulanPelaksana) {
        val intent = Intent(activity, DetailPelaksanaBagianKepegawaianActivity::class.java)
