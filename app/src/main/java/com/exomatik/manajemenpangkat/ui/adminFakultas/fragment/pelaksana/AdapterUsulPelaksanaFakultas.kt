...
class AdapterUsulPelaksanaFakultas (private val listKelas : ArrayList<ModelUsulanPelaksana>,
                                    private val getDataPengurus: (String, AppCompatTextView) -> Unit,
                                    private val onClickItem: (ModelUsulanPelaksana) -> Unit
) : RecyclerView.Adapter<AdapterUsulPelaksanaFakultas.AfiliasiHolder>(){
