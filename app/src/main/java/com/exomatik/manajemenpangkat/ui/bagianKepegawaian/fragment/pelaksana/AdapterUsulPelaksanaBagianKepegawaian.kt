...
class AdapterUsulPelaksanaBagianKepegawaian (private val listKelas : ArrayList<ModelUsulanPelaksana>,
                                             private val getDataPengurus: (String, AppCompatTextView) -> Unit,
                                             private val onClickItem: (ModelUsulanPelaksana) -> Unit
) : RecyclerView.Adapter<AdapterUsulPelaksanaBagianKepegawaian.AfiliasiHolder>(){
