...
class AdapterDaftarSKPelaksanaKepegawaian (private val listKelas : ArrayList<ModelUsulanPelaksana>,
                                           private val getDataPengurus: (String, AppCompatTextView) -> Unit,
                                           private val onClickItem: (ModelUsulanPelaksana) -> Unit
) : RecyclerView.Adapter<AdapterDaftarSKPelaksanaKepegawaian.AfiliasiHolder>(){
