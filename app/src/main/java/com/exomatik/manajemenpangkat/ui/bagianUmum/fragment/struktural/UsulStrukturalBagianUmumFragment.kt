...
class UsulStrukturalBagianUmumFragment : Fragment() {
    private lateinit var savedData : DataSave
    private var listPengajuan = ArrayList<ModelUsulanStruktural>()
    private var adapter: AdapterUsulStrukturalBagianUmum? = null
    ...
    private fun myCodeHere(){
        ...
        adapter =
            AdapterUsulStrukturalBagianUmum(
                listPengajuan,
    ...
    private fun onClickItem(item: ModelUsulanStruktural) {
        val intent = Intent(activity, DetailStrukturalBagianUmumActivity::class.java)
