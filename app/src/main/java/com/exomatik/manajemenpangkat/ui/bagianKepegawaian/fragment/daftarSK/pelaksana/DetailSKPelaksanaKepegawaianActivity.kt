package com.exomatik.manajemenpangkat.ui.bagianKepegawaian.fragment.daftarSK.pelaksana
...
import kotlinx.android.synthetic.main.activity_detail_daftar_pelaksana_kepegawaian.*
import java.util.*

class DetailSKPelaksanaKepegawaianActivity : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_detail_daftar_pelaksana_kepegawaian)
        myCodeHere()
    }
    ...
    private fun acceptDisposisi(nip: String, tglPengajuan: String, urlFile: String){
        Toast.makeText(this, "SK berhasil di upload", Toast.LENGTH_LONG).show()
        progress.visibility = View.GONE
