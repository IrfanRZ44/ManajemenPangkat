...
class AdapterUsulStrukturalBagianKepegawaian (private val listKelas : ArrayList<ModelUsulanStruktural>,
                                              private val getDataPengurus: (String, AppCompatTextView) -> Unit,
                                              private val onClickItem: (ModelUsulanStruktural) -> Unit
) : RecyclerView.Adapter<AdapterUsulStrukturalBagianKepegawaian.AfiliasiHolder>(){
