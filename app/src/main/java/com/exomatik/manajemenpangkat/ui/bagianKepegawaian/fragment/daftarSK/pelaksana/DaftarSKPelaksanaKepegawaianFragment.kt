...
class DaftarSKPelaksanaKepegawaianFragment : Fragment() {
    private lateinit var savedData : DataSave
    private var listPengajuan = ArrayList<ModelUsulanPelaksana>()
    private var adapter: AdapterDaftarSKPelaksanaKepegawaian? = null
    ...
    private fun myCodeHere(){
        ...
        adapter = AdapterDaftarSKPelaksanaKepegawaian(
                listPengajuan,
    ...
    private fun onClickItem(item: ModelUsulanPelaksana) {
        val intent = Intent(activity, DetailSKPelaksanaKepegawaianActivity::class.java)
